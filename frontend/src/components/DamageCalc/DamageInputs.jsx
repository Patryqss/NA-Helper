  ...
  <div className="damage-dealing">
    ...
    <div className="damage-body">
      <div className="damage1">
        <input key="0" id={0} type="number" onChange={handleDamageChange} value={input[0].damage.toString()} />
        <div>
      ...
      <div className="damage2">
        <input key="1" id={1} type="number" onChange={handleDamageChange} value={input[1].damage.toString()} />
        <div>
      ...
      <div className="damage3">
        <input key="2" id={2} type="number" onChange={handleDamageChange} value={input[2].damage.toString()} />
        <div>
