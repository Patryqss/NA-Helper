...
class skillFilter extends React.Component {
    constructor(props) {
        ...
        this.filters = ["Additional Damage", "Affects Chakra Cost", "Affects Cooldown", "Affects Duration", "Affliction", "Alternate Skill", "AOE", "Become Invulnerable", "Bloodline", "Cannot be countered", "Cannot be killed", "Counter", "Damage over Time", "Damage Reduction", "DD Destroy", "Destructible Defense", "Gain Chakra", "Genjutsu", "Healing", "Ignore Friendly", "Ignores", "Increase Damage", "Insta-kill", "Invisible", "Ninjutsu", "None", "Piercing", "Random", "Reduce Dealt Damage", "Reflect", "Remove Chakra", "Steal Chakra", "Steal Health", "Stun", "Taijutsu", "Through Invulnerable", "Unable to Reduce"]
    }
